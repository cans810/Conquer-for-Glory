...
public class SettingsManager : MonoBehaviour
{
    ...
    public void surrender(){
        ...
        battleController.GetComponent<BattleController>().loseCanvas.gameObject.transform.Find("Coin Amount").GetComponent<TextMeshProUGUI>().text = "-Respect of your soldiers...";
        battleController.GetComponent<BattleController>().loseCanvas.gameObject.transform.Find("CoinImage").set;
        CloseSettingsTab();
    }
