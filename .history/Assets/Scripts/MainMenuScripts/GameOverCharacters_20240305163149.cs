...
public class GameOverCharacters : MonoBehaviour
{
    ...
    public void SelectedYes(){
        ...
        GameManager.Instance.playerSoldierIDs.Clear();

        GameManager.Instance.SaveGameData(GameManager.Instance.gameData);
        
        GameManager.Instance.LoadGameData();

        GameObject.Find("MenusBackgroundMusic").GetComponent<MenusMusicController>().StartMusicAgain();
    }
