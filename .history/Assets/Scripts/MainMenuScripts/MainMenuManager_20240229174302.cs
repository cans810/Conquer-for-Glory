...
public class MainMenuManager : MonoBehaviour
{
    ...
    {
        StartCoroutine(WaitOneSecAndQuit());
    }

    IEnumerator WaitOneSecAndQuit(){

        if (DataPersistanceManager.instance.gameData != null && DataPersistanceManager.instance.gameStateData != null){
