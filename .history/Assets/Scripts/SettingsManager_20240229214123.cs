...
public class SettingsManager : MonoBehaviour
{
    ...
    public void surrender(){
        ...
        battleController.GetComponent<BattleController>().loseCanvas.gameObject.transform.Find("Coin Amount").gameObject.GetComponent<TextMeshProUGUI>().text = "-Respect of your soldiers...";
