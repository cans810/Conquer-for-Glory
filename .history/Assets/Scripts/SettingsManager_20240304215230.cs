...
public class SettingsManager : MonoBehaviour
{
    ...
    public GameObject pauseBattleButton;
    ...
    void Start()
    {
        ...
        pauseBattleButton.GetComponent<Button>().onClick.AddListener(pauseBattle);
    }
    ...
    void Update()
    {
        ...
        if (SceneManager.GetActiveScene().name.Equals("MainMenuScene")){
            ...
            pauseBattleButton.SetActive(false);
        }
        ...
        if (SceneManager.GetActiveScene().name.Equals("MarketScene")){
            ...
            settingsButton.transform.localPosition = new Vector3(-80,350,0);
            ...
            pauseBattleButton.SetActive(true);
        }
