...
public class SettingsManager : MonoBehaviour
{
    ...
    public void surrender(){
        ...
        battleController.GetComponent<BattleController>().loseCanvas.gameObject.transform.Find("Coin Amount").GetComponent<TextMeshProUGUI>().text = "-Repect of your soldiers...";
        CloseSettingsTab();
    }
