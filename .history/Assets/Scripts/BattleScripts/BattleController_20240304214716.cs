...
public class BattleController : MonoBehaviour
{
    ...
    public void OnButtonPressed(Button button)
    {
        ...
        StartCoroutine(ResetButtonColorCoroutine(button, button.image.color));
    }
    ...
    private IEnumerator ResetButtonColorCoroutine(Button button)
    {
        ...
        button.image.color = button.image.color = new Color(button.image.color.r,button.image.color.g,button.image.color.b,97f/255f);;
    }
