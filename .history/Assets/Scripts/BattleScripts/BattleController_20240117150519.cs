            ...
            if (enemyDeathCounterUlti >= 20){
                ...
                if (Input.GetKeyDown(KeyCode.Q))
                {
                    ...
                    if (parentTransform.GetChild(currentSelectedSoldierContainer).GetComponent<SoldierContainerManager>().canSummon){
                        ...
                        // ulti sesi oynat
                        if (gameObject.transform.Find("BattleGroundSoundsManager")){
                            gameObject.transform.Find("BattleGroundSoundsManager").gameObject.GetComponent<BattleGroundSoundsManager>().playUltiSound("Player");
                        }
