...
public class EnemySummonController : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            if (parentTransformSoldierContainers != null){
                ...
                else if (parentTransformSoldierContainers.GetChild(currentSelectedSoldierContainer).GetComponent<SoldierContainerManager>().canSummon && battlecontroller.GetComponent<BattleController>().playerDeathCounterUlti < 23){
                    summonPointSelector();
