...
public class BattleController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (playerWon && !battleEnded){
            ...
            winCanvas.gameObject.transform.Find("Coin Amount").GetComponent<TextMeshProUGUI>().text = "+" + 300 + enemyDeathCounterCoin*2;
            ...
            loseCanvas.gameObject.transform.Find("Coin Amount").GetComponent<TextMeshProUGUI>().text = "+" + 300 + enemyDeathCounterCoin*2;
