...
public class EnemySummonController : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            if (parentTransformSoldierContainers != null){
                ...
                if (parentTransformSoldierContainers.GetChild(currentSelectedSoldierContainer).GetComponent<SoldierContainerManager>().canSummon && battlecontroller.GetComponent<BattleController>().playerDeathCounterUlti >= 23){
    ...
    public void summonPointSelector(){
        ...
        {
            currentSelectedSummonPoint = UnityEngine.Random.Range(0, 8);
        }
        else{
            int highestValue = -1;
            int highestKey = -1;
