        ...
        if (!battleEnded){
            ...
            if (Input.GetKeyDown(KeyCode.Space))
            {
                ...
                if (parentTransform.GetChild(currentSelectedSoldierContainer).GetComponent<SoldierContainerManager>().canSummon){
                    ...
                    if (parentTransform.GetChild(currentSelectedSoldierContainer).GetComponent<SoldierContainerManager>().SoldierContained.GetComponent<Entity>().soldierType.Equals("EasternLion")){
                        spawnPosition = summonPoint.position - new Vector3(0.5f, summonPointHeight / 2.5f, 0);
                        Debug.Log("aaaa");
                    }
