...
public class BattleController : MonoBehaviour
{
    ...
    void Update()
    {
        if (!battleEnded){
            ...
            if (Input.GetKeyDown(KeyCode.Space) || SettingsManager.Instance.autoSummon)
            {
                Transform parentTransform = PlayerSoldierContainers.transform;
                ...
                if (parentTransform.GetChild(currentSelectedSoldierContainer).GetComponent<SoldierContainerManager>().canSummon){
                    ...
                    if (parentTransform.GetChild(currentSelectedSoldierContainer).GetComponent<SoldierContainerManager>().SoldierContained.name.Equals("Mammoth")){
            ...
            if (enemyDeathCounterUlti >= 20){
                ...
                if (Input.GetKeyDown(KeyCode.Q) || SettingsManager.Instance.autoSummon)
                {
                    Transform parentTransform = PlayerSoldierContainers.transform;
                    ...
                    if (parentTransform.GetChild(currentSelectedSoldierContainer).GetComponent<SoldierContainerManager>().canSummon){
                        ...
                        // ulti sesi oynat
                        if (GameObject.Find("BattleGroundSoundsManager")){
                            GameObject.Find("BattleGroundSoundsManager").GetComponent<BattleGroundSoundsManager>().playUltiSound("Player");
                        }
