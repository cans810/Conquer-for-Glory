        ...
        if (!GetComponent<Entity>().dead){
            ...
            GetComponent<Entity>().HitBox.GetComponent<HitBoxController>().currentHittingOpponent != null && !playingAttackAnim){
                ...
                if (randomAttackAnim == 0){
                    ...
                    gameObject.GetComponent<Entity>().animator.SetBool("MountedSwordsman_Attack_2",true);
                }
            }
                ...
                gameObject.GetComponent<Entity>().animator.SetBool("MountedSwordsman_Attack_2",false);
