...
public class EntitySoundManager : MonoBehaviour
{
    ...
    public void Update(){
        if (!SceneManager.GetActiveScene().name.Equals("MarketScene")){
            ...
            outsideEffectSource.volume = SettingsManager.Instance.BattleSoundsVolume - 0.4f;
            groundSource.volume = SettingsManager.Instance.BattleSoundsVolume;
            specialSoldierSource.volume = SettingsManager.Instance.BattleSoundsVolume + 0.5f;
        }
