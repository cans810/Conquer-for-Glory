...
public class OrcBeastController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        .dead){
            if (entity
            .HitBox.GetComponent<HitBoxController>().colliding && entity
            .HitBox.GetComponent<HitBoxController>().currentHittingOpponent != null 
            && !playingAttackAnim && (float)entity
            .HitBox.GetComponent<HitBoxController>().currentHittingOpponent.entity
            .HP - (float)entity.damage > 0.0f){
                ...
                enemyToRipOff = entity
                .HitBox.GetComponent<HitBoxController>().currentHittingOpponent;
            }
            else if(entity
            .HitBox.GetComponent<HitBoxController>().colliding && entity
            .HitBox.GetComponent<HitBoxController>().currentHittingOpponent != null 
            ...
            .HitBox.GetComponent<HitBoxController>().colliding && !playingAttackAnim){
                ...
                GetComponent<EntityCommonActions>().walk(entity
                .direction,entity
                .speed);
            }
        }
