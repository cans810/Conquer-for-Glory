...
public class OrcBeastController : MonoBehaviour
{
    ...
    void Update()
    {
        if (!GetComponent<Entity>().dead){
            ...
            && !playingAttackAnim && (float)GetComponent<Entity>().HitBox.GetComponent<HitBoxController>().currentHittingOpponent.GetComponent<Entity>().HP - (float)entity.damage > 0.0f){
    ...
    public void damageEnemy(){
        enemyToRipOff.GetComponent<Entity>().HP -= entity.damage;
    }
