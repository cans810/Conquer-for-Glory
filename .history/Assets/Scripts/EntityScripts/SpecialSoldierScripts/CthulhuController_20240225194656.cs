...
public class CthulhuController : MonoBehaviour
{
        ...
        if (!GetComponent<Entity>().dead){
            ...
            GetComponent<Entity>().HitBox.GetComponent<HitBoxController>().currentHittingOpponent != null && !playingAttackAnim){
                ...
                if (randomAttackAnim == 0){
                    gameObject.GetComponent<Entity>().animator.SetBool("Attack",true);
                }
                ...
                gameObject.GetComponent<Entity>().animator.SetBool("Attack",false);
    ...
    public void useDarkMagicOnEnemy(){
        foundEnemy.GetComponent<Animator>().SetBool("DarkMagicEffect",true);
    ...
    public GameObject searchForEnemys(){
        ...
        if (tag.Equals("Player")){
            ...
            if (enemies.Length > 0)
            {
                ...
                if (!foundEnemy.GetComponent<Entity>().canDarkMagicEffect){
                    searchForEnemys();
                }
