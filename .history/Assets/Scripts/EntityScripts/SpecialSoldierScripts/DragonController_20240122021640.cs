...
public class DragonController : MonoBehaviour
{
    ...
    void Update()
    {
        if (!GetComponent<Entity>().dead){
            ...
            else if (fireHitbox.GetComponent<DragonFireHitBoxController>().colliding && fireHitbox.GetComponent<DragonFireHitBoxController>().currentHittingOpponents != null && !playingAttackAnim){
                gameObject.GetComponent<Entity>().animator.SetBool("Dragon_Fly",false);
