...
public class Entity : MonoBehaviour
{
    ...
    public bool burning;
    public bool gettingDarkMagicEffect;
    public bool canGetKnockedBack;
    public bool canBeRipped;
    public bool canBurn;
    public bool canDarkMagicEffect;
    ...
    void Start()
    {
        ...
        StartCoroutine(AdjustSoldierDifficulty());
    }
    ...
    IEnumerator AdjustSoldierDifficulty(){
        ...
        if (tag.Equals("Enemy"))
        {
            ...
            if (soldierType.Equals("Archer")){
                ...
                for (int i = 0; i < GameManager.Instance.DynamicDifficulty; i++)
                {
                    GetComponent<ArcherController>().arrowLowerAngleBound += 0.05f;
                    GetComponent<ArcherController>().arrowUpperAngleBound -= 0.05f;
    ...
    public void damageOpponentMelee()
    {
        if (HitBox.GetComponent<HitBoxController>().currentHittingOpponent != null)
        {
            ...
            if (opponentEntity != null)
            {
                ...
                || soldierType == "OrcBeast" || soldierType == "Cthulhu"){
