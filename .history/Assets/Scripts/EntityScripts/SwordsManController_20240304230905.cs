    ...
    void Update()
    {
        if (!entity.dead){
            ...
            && !entity.gettingDarkMagicEffect){
                ...
                gameObject.entity.animator.SetBool("Walk",false);
                ...
                if (randomAttackAnim == 0){
                    gameObject.entity.animator.SetBool("Swordsman_Attack",true);
                }
                else if (randomAttackAnim == 1){
                    gameObject.entity.animator.SetBool("Swordsman_Attack_2",true);
                }
            }
            else if (!entity.HitBox.GetComponent<HitBoxController>().colliding && !playingAttackAnim && !entity.burning
            && !entity.gettingDarkMagicEffect){
                gameObject.entity.animator.SetBool("Swordsman_Attack",false);
                gameObject.entity.animator.SetBool("Swordsman_Attack_2",false);
                gameObject.entity.animator.SetBool("Walk",true);
