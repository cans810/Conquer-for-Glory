...
public class SpriteLibraryManager : MonoBehaviour
{
    ...
    public void Awake(){
        ...
        else if (gameObject.GetComponent<Entity>().race.Equals("EasternHuman")){
            gameObject.GetComponent<SpriteLibrary>().spriteLibraryAsset = RaceModels[5];
        }
        else if (gameObject.GetComponent<Entity>().race.Equals("Wraith")){
            gameObject.GetComponent<SpriteLibrary>().spriteLibraryAsset = RaceModels[6];
        }
