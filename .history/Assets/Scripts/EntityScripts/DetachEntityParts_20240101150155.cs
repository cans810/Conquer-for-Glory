    ...
    public void detachHead()
{
    ...
    if (foundHead != null)
    {
        ...
        if (originalRenderer != null)
        {
            ...
            detachedHead.transform.localScale = Vector3.one; // Reset scale to (1,1,1) before applying the new scale
            detachedHead.transform.localScale = foundHead.lossyScale; // Use lossyScale to consider parent scaling
        }
        else
        {
        ...
        rb.AddForce(Vector2.up * 1.4f, ForceMode2D.Impulse);
    }
    else
    {
