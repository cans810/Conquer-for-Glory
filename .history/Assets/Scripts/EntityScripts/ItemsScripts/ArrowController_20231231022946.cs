...
public class ArrowController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        int randomAngle = UnityEngine.Random.Range(sourceEntity.GetComponent<ArcherController>().arrowLowerAngleBound,sourceEntity.GetComponent<ArcherController>().arrowUpperAngleBound);
