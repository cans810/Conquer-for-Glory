    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (sourceEntity.tag.Equals("Player"))
        {
            if (collision.CompareTag("Enemy") && spawnedAtRow == entityHit.spawnedAtRow)
            {
                ...
                && !entityHit.soldierType.Equals("Dragon") && !entityHit.soldierType.Equals("Cthulhu") && !entityHit.soldierType.Equals("Cthulhu"))
                {
                ...
                || entityHit.soldierType.Equals("Minotaur") || entityHit.soldierType.Equals("OrcBeast")
                || entityHit.soldierType.Equals("Dragon") || entityHit.soldierType.Equals("Cthulhu"))
                {
