...
public class EntitySoundManager : MonoBehaviour
{
    ...
    public List<AudioClip> summonSounds;
    ...
    public void Update(){
        if (!SceneManager.GetActiveScene().name.Equals("MarketScene")){
            ...
            summonSource.volume = SettingsManager.Instance.BattleSoundsVolume;
        }
    ...
    public void playSummonSound()
    {
        if (!IsPlaying(summonSource))
        {
            ...
            // Set the stereo pan of the audio source
            summonSource.panStereo = clampedStereoPan;

            summonSource.clip = summonSounds[0];
            summonSource.Play();
        }
    }
}
