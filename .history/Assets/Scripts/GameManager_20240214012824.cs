...
public class GameManager : MonoBehaviour, IDataPersistance
{
    ...
    public void LoadData(GameData data)
    {
        ...
        foreach (GameObject soldier in data.PlayerSoldiers){
            this.PlayerSoldiers.Add(soldier);
        }
    ...
    {
        data.PlayerSoldiers = new List<GameObject>();
        foreach (GameObject soldier in this.PlayerSoldiers){
            data.PlayerSoldiers.Add(soldier);
        }
