...
public class SettingsManager : MonoBehaviour
{
    ...
    public void surrender(){
        ...
        battleController.GetComponent<BattleController>().loseCanvas.gameObject.transform.Find("SurrenderText").gameObject.GetComponent<TextMeshProUGUI>().text = "-Respect of your soldiers...";
