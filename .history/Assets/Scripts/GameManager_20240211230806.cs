...
public class GameManager : MonoBehaviour, IDataPersistance
{
    ...
    public void LoadData(GameData data)
    {
        ...
        this.playerUpgradeMap.Add("Speed Training",data.playerUpgradeMap["Speed Training"]);
        this.playerUpgradeMap.Add("Armour Increase",data.playerUpgradeMap["Armour Increase"]);
        this.playerUpgradeMap.Add("Armour Increase",data.playerUpgradeMap["Archery"]);
    ...
    public void SaveData(ref GameData data)
    {
        ...
        data.playerUpgradeMap.Add("Speed Training",this.playerUpgradeMap["Speed Training"]);
        data.playerUpgradeMap.Add("Armour Increase",this.playerUpgradeMap["Armour Increase"]);
        data.playerUpgradeMap.Add("Archery",this.playerUpgradeMap["Archery"]);
