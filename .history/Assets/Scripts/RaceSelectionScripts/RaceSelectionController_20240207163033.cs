...
public class RaceSelectionController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        raceInfos[0] = "+ SwordsMan Damage, + AxeMan Damage";
        raceInfos[0] = "+ Walking Speed";
        raceInfos[0] = "+ SpearMan Damage, + SpearMan HP";
        raceInfos[0] = "+ SwordsMan Damage, + SwordsMan HP";
        raceInfos[0] = "+ Walking Speed, + Sorcerer Damage";
    }
