...
public class RaceSelectionController : MonoBehaviour
{
    ...
    public void setCurrentRaceAndContinue(){
        ...
        if (GameManager.Instance.PlayerRace.Equals("Demon") && GameManager.Instance.finishedGameCtr < 1){
        ...
        if (GameManager.Instance.PlayerRace.Equals("Wraith") && GameManager.Instance.finishedGameCtr < 2){
