...
public class RaceSelectionController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        raceInfos = new List<string>();

        raceInfos.Add("+ SwordsMan HP");
        raceInfos.Add("+ Archer Damage");
        raceInfos.Add("+ SwordsMan Damage, + AxeMan Damage");
        raceInfos.Add("+ Walking Speed");
        raceInfos.Add("+ SpearMan Damage, + SpearMan HP");
        raceInfos.Add("+ SwordsMan Damage, + SwordsMan HP");
        raceInfos.Add("+ Walking Speed, + Sorcerer Damage");

        raceInfos[1] = "+ Archer Damage";
        raceInfos[2] = "+ SwordsMan Damage, + AxeMan Damage";
        raceInfos[3] = "+ Walking Speed";
        raceInfos[4] = "+ SpearMan Damage, + SpearMan HP";
        raceInfos[5] = "+ SwordsMan Damage, + SwordsMan HP";
        raceInfos[6] = "+ Walking Speed, + Sorcerer Damage";
