...
public class GameManager : MonoBehaviour, IDataPersistance
{
    ...
    public void SaveData(ref GameData data)
    {
        ...
        data.playerUpgradeMap["Speed Training"] = this.playerUpgradeMap["Speed Training"];
        data.playerUpgradeMap["Armour Increase"] = this.playerUpgradeMap["Armour Increase"];
        data.playerUpgradeMap["Archery"] = this.playerUpgradeMap["Archery"];
    ...
    private void Awake()
    {
        ...
        this.playerUpgradeMap.Add("Speed Training",playerUpgradeMap["Speed Training"]);
        this.playerUpgradeMap.Add("Armour Increase",playerUpgradeMap["Armour Increase"]);
        this.playerUpgradeMap.Add("Archery",playerUpgradeMap["Archery"]);
    }
}
