...
public class SettingsManager : MonoBehaviour
{
    ...
    public void surrender(){
        ...
        battleController.GetComponent<BattleController>().loseCanvas.gameObject.transform.Find("Coin Amount")..gameObjectGetComponent<TextMeshProUGUI>().text = "-Respect of your soldiers...";
