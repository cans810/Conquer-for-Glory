...
public class GameManager : MonoBehaviour, IDataPersistance
{
    ...
    public void LoadGameStateData(GameStateData data)
    {
        this.DemonUnlocked = data.DemonUnlocked;
        this.WraithUnlocked = data.WraithUnlocked;
        this.finishedGameCtr = data.finishedGameCtr;
    }

    public void SaveGameStateData(ref GameStateData data)
    {
        data.DemonUnlocked = this.DemonUnlocked;
        data.WraithUnlocked = data.WraithUnlocked;
        data.finishedGameCtr = data.finishedGameCtr;
    }
