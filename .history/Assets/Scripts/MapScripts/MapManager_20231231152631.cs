...
public class MapManager : MonoBehaviour
{
    ...
    public GameObject MapDownObject;
    ...
    void Update()
    {
        if (SceneManager.GetActiveScene().name.Equals("MapScene")){
            MapObject = GameObject.Find("Map");
            MapDownObject = GameObject.Find("MapDown");

            if(MapObject.activeSelf && isEveryLandConquered()){
    ...
    public void viewMapMore(){
        if (MapObject.activeSelf){
            MapObject.SetActive(false);
            MapDownObject.SetActive(true);
        }
        else if (MapDownObject.activeSelf){
            MapDownObject.SetActive(false);
