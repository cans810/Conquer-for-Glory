            ...
            if (canAttack) {
                ...
                foreach (GameObject neighbour in Neighbours) {
                    if (neighbour != null && neighbour.GetComponent<CityInfo>().isConqueredByPlayer) {
                        ...
                        RectTransform popupInfo = attackablePointer.transform.Find("PopupInfo").GetComponent<RectTransform>();
                        ...
                        popupInfo.rotation = reverseRotation * attackablePointer.transform.rotation;
                    }
                }
            }
