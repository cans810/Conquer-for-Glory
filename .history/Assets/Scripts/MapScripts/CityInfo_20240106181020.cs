            ...
            if (canAttack) {
                ...
                foreach (GameObject neighbour in Neighbours) {
                    if (neighbour != null && neighbour.GetComponent<CityInfo>().isConqueredByPlayer) {
                        ...
                        attackablePointer.transform.Find("PopupInfo").transform.rotation = Quaternion.identity;
                        attackablePointer.transform.Find("PopupInfo").transform.localScale = new Vector3(1,1,1);
                    }
                }
            }
