...
{   
    ...
    public GameObject SeaElfMarket;
    ...
    void Start()
    {
        ...
        if (GameManager.Instance.PlayerRace.Equals("Human")){
            ...
            EasternHumanMarket.SetActive(false);
            WraithMarket.SetActive(false);
            SeaElfMarket.SetActive(true);

            //eğer zaten marketteki askerlerden biri oyuncuda varsa o zaman o askeri marketten çıkar
            Transform parentTransform = SeaElfMarket.transform;
    ...
    public void buySelectedUpgrade(){
        ...
        if (GameManager.Instance.balance >= currentSelectedUpgrade.GetComponent<UpgradeButtonController>().price){
            ...
            else if(currentSelectedUpgradeInfoText.GetComponent<TextMeshProUGUI>().text.Equals("Speed Training") && GameManager.Instance.speedTrainingPoint >= 3){
            ...
            else if(currentSelectedUpgradeInfoText.GetComponent<TextMeshProUGUI>().text.Equals("Armour Increase") && GameManager.Instance.armourIncreasePoint >= 3){
                errorText.SetActive(true);
                errorText.GetComponent<Animator>().SetBool("ShowError",false);
                errorText.GetComponent<Animator>().SetBool("ShowError",true);
                errorText.GetComponent<TextMeshProUGUI>().text = "You can't upgrade more!";
            ...
            else if(currentSelectedUpgradeInfoText.GetComponent<TextMeshProUGUI>().text.Equals("Archery") && GameManager.Instance.archeryPoint >= 3){
                errorText.SetActive(true);
                errorText.GetComponent<Animator>().SetBool("ShowError",false);
                errorText.GetComponent<Animator>().SetBool("ShowError",true);
                errorText.GetComponent<TextMeshProUGUI>().text = "You can't upgrade more!";
    ...
    public void findActualSoldierSelected(){
        ...
        if (GameManager.Instance.PlayerRace.Equals("Human")){
                ...
                if (GameManager.Instance.PlayerRace.Equals("SeaElf")){
                    if (currentSelectedSoldier.name.Equals("AxeMan")){
                        actualSoldierGameObject = GetComponent<HumanBuyableSoldiersContainer>().SeaElfSpecialBuyableSoldiers[0];
                    }
                    else if (currentSelectedSoldier.name.Equals("MountedSpearMan")){
                        actualSoldierGameObject = GetComponent<HumanBuyableSoldiersContainer>().SeaElfSpecialBuyableSoldiers[1];
                    }
                    else if (currentSelectedSoldier.name.Equals("HatchetMan")){
                        actualSoldierGameObject = GetComponent<HumanBuyableSoldiersContainer>().SeaElfSpecialBuyableSoldiers[2];
                    }
                    else if (currentSelectedSoldier.name.Equals("Sorcerer")){
                        actualSoldierGameObject = GetComponent<HumanBuyableSoldiersContainer>().SeaElfSpecialBuyableSoldiers[3];
                    }
                    else if (currentSelectedSoldier.name.Equals("Sorcerer")){
                        actualSoldierGameObject = GetComponent<HumanBuyableSoldiersContainer>().SeaElfSpecialBuyableSoldiers[4];
                    }
                    else if (currentSelectedSoldier.name.Equals("Cthulhu")){
                        actualSoldierGameObject = GetComponent<HumanBuyableSoldiersContainer>().SeaElfSpecialBuyableSoldiers[5];
                    }
                }
    }
}
