    ...
    public void findActualSoldierSelected(){
        ...
        if (GameManager.Instance.PlayerRace.Equals("Human")){
                    ...
                    if (currentSelectedSoldier.name.Equals("AxeMan")){
                        ...
                        actualSoldierGameObject = GetComponent<HumanBuyableSoldiersContainer>().HumanSpecialBuyableSoldiers[6];
                    }
                }
                ...
                if (GameManager.Instance.PlayerRace.Equals("Demon")){
                    if (currentSelectedSoldier.name.Equals("AxeMan")){
                        ...
                        actualSoldierGameObject = GetComponent<HumanBuyableSoldiersContainer>().DemonSpecialBuyableSoldiers[6];
                    }
                }
