...
{   
    ...
    public void buySelectedUpgrade(){
        ...
        if (GameManager.Instance.balance >= currentSelectedUpgrade.GetComponent<UpgradeButtonController>().price){
            if (currentSelectedUpgradeInfoText.GetComponent<TextMeshProUGUI>().text.Equals("Speed Training") && GameManager.Instance.playerUpgradeMap["Speed Training"] < 3){
                GameManager.Instance.playerUpgradeMap["Speed Training"] += 1;
                currentSelectedUpgrade.GetComponent<UpgradeButtonController>().price += 100;
            }
            else if(GameManager.Instance.playerUpgradeMap["Speed Training"] >= 3){
            ...
            if (currentSelectedUpgradeInfoText.GetComponent<TextMeshProUGUI>().text.Equals("Armour Increase") && GameManager.Instance.playerUpgradeMap["Armour Increase"] < 3){
                GameManager.Instance.playerUpgradeMap["Armour Increase"] += 1;
                currentSelectedUpgrade.GetComponent<UpgradeButtonController>().price += 100;
            }
            else if(GameManager.Instance.playerUpgradeMap["Armour Increase"] >= 3){
                errorText.SetActive(true);
                errorText.GetComponent<Animator>().SetBool("ShowError",false);
                errorText.GetComponent<Animator>().SetBool("ShowError",true);
                errorText.GetComponent<TextMeshProUGUI>().text = "You can't upgrade more!";
            ...
            if (currentSelectedUpgradeInfoText.GetComponent<TextMeshProUGUI>().text.Equals("Archery") && GameManager.Instance.playerUpgradeMap["Archery"] < 3){
                GameManager.Instance.playerUpgradeMap["Archery"] += 1;
                currentSelectedUpgrade.GetComponent<UpgradeButtonController>().price += 100;
            }
            else if(GameManager.Instance.playerUpgradeMap["Archery"] >= 3){
                errorText.SetActive(true);
                errorText.GetComponent<Animator>().SetBool("ShowError",false);
                errorText.GetComponent<Animator>().SetBool("ShowError",true);
                errorText.GetComponent<TextMeshProUGUI>().text = "You can't upgrade more!";
