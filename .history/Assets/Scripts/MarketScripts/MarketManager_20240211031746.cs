...
{   
    ...
    public void buySelectedUpgrade(){
        ...
        if (GameManager.Instance.balance >= currentSelectedUpgrade.GetComponent<UpgradeButtonController>().price && (GameManager.Instance.playerUpgradeMap["Speed Training"] < 3 || GameManager.Instance.playerUpgradeMap["Armour Increase"] < 3 || 
        GameManager.Instance.playerUpgradeMap["Archery"] < 3)){
