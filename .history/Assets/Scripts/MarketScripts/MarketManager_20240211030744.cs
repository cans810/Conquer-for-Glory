...
{   
    ...
    public void Update(){
        ...
        if(currentSelectedUpgrade != null){
            ...
            currentSelectedUpgrade.GetComponent<UpgradeButtonController>().infoBubble.SetActive(true);
        } 
            ...
            currentSelectedUpgrade.GetComponent<UpgradeButtonController>().infoBubble.SetActive(false);
        } 
    }
